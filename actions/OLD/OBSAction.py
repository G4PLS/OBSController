...
from data.plugins.com_gapls_OBSController.internal.OBSConfig import OBSConfigWindow
from data.plugins.com_gapls_OBSController.internal.PluginConfig import PluginConfigButton
