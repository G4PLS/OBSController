...
class OBSConfigWindow(PluginConfigWindow):
    ...
    def build(self):
        ...
        self.connection_button = Gtk.Button(label="Test Connection", hexpand=True)
        ...
        self.main_box.append(self.connection_button)
    ...
    def save_clicked(self, *args):
        ...
        settings["ip-address"] = self.network_entry.get_ip()
    ...
    def connection_test(self, *args):
        if self.plugin_base.backend.test_connection():
